...
namespace onebot {
    namespace Event {
        ...
        nlohmann::json onGroupDecreaseReceived(const nlohmann::json& data)
        {
        ...
        nlohmann::json onGroupJoinRequestReceived(const nlohmann::json& data)
        {
        ...
        {
            return onGroupDecreaseReceived<GroupDecreaseNotice::LEAVE>(data);
        }

        nlohmann::json onGroupMemberKickMeNoticeReceived(const nlohmann::json& data)
        {
            return onGroupDecreaseReceived<GroupDecreaseNotice::KICK_ME>(data);
        }

        nlohmann::json onFriendAddNoticeReceived(const nlohmann::json& data)
        {
            return onFriendNoticeReceived<FriendAddNotice>(data);
        }

        nlohmann::json onFriendDelNoticeReceived(const nlohmann::json& data)
        {
            return onFriendNoticeReceived<FriendDelNotice>(data);
        }

        nlohmann::json onGroupMemberJoinRequestReceived(const nlohmann::json& data)
        {
            return onGroupJoinRequestReceived<GroupJoinRequest::ADD>(data);
        }

        nlohmann::json onGroupInviteMeRequestReceived(const nlohmann::json& data)
        {
            return onGroupJoinRequestReceived<GroupJoinRequest::INVITE>(data);
        }
    }
}